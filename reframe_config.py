            ...
            'handlers_perflog': [
                {
                    ...
                    'format': (
                        ...
                        'num_mpi_tasks=%(check_job_num_tasks)s|'
                        'num_total_cores=%(check_job_num_total_cores)s|'
                        'num_nodes=%(check_job_num_nodes)s|'
                        'num_omp_threads=%(check_job_num_omp_threads)s|'
                        'num_tasks_per_node=%(check_job_num_tasks_per_node)s|'
